...
import anonymous.dp.service.heavyhitter.config.*;
import anonymous.dp.service.heavyhitter.config.CnrHhgHhLdpConfig.Builder;
import anonymous.dp.service.heavyhitter.fo.FoHhLdpServer;
import anonymous.dp.service.heavyhitter.hg.*;
import anonymous.dp.service.heavyhitter.fo.FoHhLdpClient;
...
public class HhLdpFactory {
    ...
    public static HhLdpConfig createDefaultHhLdpConfig(HhLdpType type, Set<String> domainSet, int k, double windowEpsilon) {
        switch (type) {
            ...
            case CNR:
                return new Builder(domainSet, k, windowEpsilon).build();
            default:
        ...
        switch (type) {
            ...
            case BDR:
                return new BdrHhgHhLdpConfig
                    ...
                    .build();
            case CNR:
                return new Builder(domainSet, k, windowEpsilon)
                    .setBucketParams(w, lambdaH)
                    .setHgRandom(hgRandom)
                    .build();
            default:
