...
import anonymous.dp.service.fo.cms.AppleHcmsFoLdpClient;
import anonymous.dp.service.fo.config.*;
import anonymous.dp.service.fo.config.AppleHcmsFoLdpConfig.Builder;
import anonymous.dp.service.fo.de.DeIndexFoLdpClient;
import anonymous.dp.service.fo.de.DeStringFoLdpClient;
import anonymous.dp.service.fo.de.DeStringFoLdpServer;
import anonymous.dp.service.fo.hadamard.*;
import anonymous.dp.service.fo.lh.*;
import anonymous.dp.service.fo.rappor.RapporFoLdpServer;
import anonymous.dp.service.fo.ue.OueFoLdpServer;
import anonymous.dp.service.fo.ue.SueFoLdpServer;
import anonymous.dp.service.fo.cms.AppleCmsFoLdpClient;
import anonymous.dp.service.fo.cms.AppleCmsFoLdpServer;
import anonymous.dp.service.fo.cms.AppleHcmsFoLdpServer;
import anonymous.dp.service.fo.de.DeIndexFoLdpServer;
import anonymous.dp.service.fo.rappor.RapporFoLdpClient;
import anonymous.dp.service.fo.ue.OueFoLdpClient;
import anonymous.dp.service.fo.ue.SueFoLdpClient;
...
public class FoLdpFactory {
    ...
    public static FoLdpConfig createDefaultConfig(FoLdpType type, Set<String> domainSet, double epsilon) {
        switch (type) {
            ...
            case APPLE_HCMS:
                return new Builder(type, domainSet, epsilon).build();
            default:
                throw new IllegalArgumentException("Invalid " + FoLdpType.class.getSimpleName() + ": " + type.name());
        }
    }
